...
class thost_recent_post_widget extends WP_Widget {
	/* Widget setup */
	public function __construct() {
		$widget_ops = array(
			'classname'   => 'recent-post-widget',
			'description' => esc_html__( 'A widget show post', 'thost' ),
		);
	...
	function form( $instance ) {
		...
		$defaults = array(
			'title' => esc_html__('Recent Post', 'thost'),
			'order' => 'DESC'
		);
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'select_cat' ) ); ?>">
				<?php esc_attr_e( 'Select Categories:', 'thost' ); ?>
            </label>
            ...
            <select id="<?php echo esc_attr( $this->get_field_id( 'select_cat' ) ); ?>"
                ...
                <option value="0" <?php echo( in_array( 0, $select_cat ) ? 'selected="selected"' : '' ); ?>>
					<?php esc_html_e( 'All Category', 'thost' ); ?>
                </option>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>">
				<?php esc_html_e( 'Number of posts to show:', 'thost' ); ?>
            </label>
...
// Register widget
function thost_recent_post_widget_register() {
	register_widget( 'thost_recent_post_widget' );
}

add_action( 'widgets_init', 'thost_recent_post_widget_register' );